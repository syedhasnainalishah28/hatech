...
<head>
    ...
    <title>Welcome to HA Tech</title>
    <style>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #1a0f11; border: 1px solid #d4a574; border-radius: 20px; overflow: hidden;" bgcolor="#1a0f11" class="container">
                    ...
                    <tr>
                        <td style="padding: 40px; background-color: #1a0f11;" bgcolor="#1a0f11">
                            <h2 style="font-size: 28px; font-weight: 900; color: #ffffff !important; text-transform: uppercase; letter-spacing: -0.02em; margin-bottom: 20px; font-family: sans-serif;">Welcome to the Revolution</h2>
                            <p style="line-height: 1.6; color: #cccccc !important; margin-bottom: 25px; font-size: 16px; font-family: sans-serif;">Hello <strong style="color: #ffffff !important;">{{ $user->name }}</strong>,</p>
                            <p style="line-height: 1.6; color: #cccccc !important; margin-bottom: 25px; font-size: 16px; font-family: sans-serif;">We're thrilled to have you at HA Tech. You've officially joined an elite circle of digital innovators shaping the future.</p>
                            <div align="center" style="padding-top: 20px;">
                                <a href="{{ url('/login') }}" style="display: inline-block; padding: 18px 36px; background-color: #d4a574 !important; color: #0a0506 !important; font-weight: 900; border-radius: 12px; text-decoration: none; text-transform: uppercase; font-size: 14px; letter-spacing: 1px; font-family: sans-serif;">Access Dashboard</a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding: 40px; border-top: 1px solid rgba(212, 165, 116, 0.1); background-color: #150a0b;" bgcolor="#150a0b">
                            ...
                            <div style="margin-top: 20px;">
                                <a href="#" style="color: #d4a574 !important; text-decoration: none; font-weight: bold; margin: 0 10px; font-size: 11px;">INSTAGRAM</a>
                                <a href="#" style="color: #d4a574 !important; text-decoration: none; font-weight: bold; margin: 0 10px; font-size: 11px;">LINKEDIN</a>
                            </div>
