            ...
            <div class="glass-card p-6 border border-white/10 rounded-3xl">
                ...
                <div>
                    ...
                    <div id="editor-container" class="bg-[#0a0506] border border-white/10 rounded-xl overflow-hidden">
                        <div id="editor" style="height: 600px;">{!! old('body') !!}</div>
                    </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="p-4 rounded-2xl bg-black/40 border border-white/5">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="sidebar_left_show" value="1" checked class="sr-only peer">
                        ...
                        <div class="space-y-4">
                            <select name="sidebar_left_type" onchange="toggleSidebarContent('left', this.value)" class="w-full bg-black/60 border border-white/10 rounded-xl px-4 py-2 text-xs text-gray-300 focus:outline-none">
                                <option value="standard">Standard (Author & Info)</option>
                                <option value="custom">Custom (Image/HTML)</option>
                            </select>
                            <textarea id="left-content-area" name="sidebar_left_content" rows="3" class="hidden w-full bg-black/80 border border-white/10 rounded-xl px-4 py-3 text-xs text-gray-400 focus:outline-none" placeholder="Paste Small Image URL or Custom Links HTML..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="p-4 rounded-2xl bg-black/40 border border-white/5">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="sidebar_right_show" value="1" checked class="sr-only peer">
                                <div class="w-11 h-6 bg-white/10 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-gray-300 after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-500"></div>
                            </label>
                        </div>
                        <div class="space-y-4">
                            <select name="sidebar_right_type" onchange="toggleSidebarContent('right', this.value)" class="w-full bg-black/60 border border-white/10 rounded-xl px-4 py-2 text-xs text-gray-300 focus:outline-none">
                                <option value="standard">Standard (Share & Related)</option>
                                <option value="custom">Custom (Buttons/Ad)</option>
                            </select>
                            <textarea id="right-content-area" name="sidebar_right_content" rows="3" class="hidden w-full bg-black/80 border border-white/10 rounded-xl px-4 py-3 text-xs text-gray-400 focus:outline-none" placeholder="Paste custom buttons or widget code..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
