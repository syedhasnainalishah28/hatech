...
<div class="glass-card p-8 max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h4 class="text-2xl font-black uppercase tracking-tight mb-1">New Member</h4>
            <p class="text-xs text-gray-500 uppercase tracking-widest">Add to your team</p>
        </div>
    ...
    <form action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:outline-none focus:border-[#d4a574] transition-colors">
            </div>
            ...
            <div>
                ...
                <input type="text" name="email" value="{{ old('email') }}" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:outline-none focus:border-[#d4a574] transition-colors">
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div>
                ...
                <input type="text" name="linkedin_url" value="{{ old('linkedin_url') }}" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:outline-none focus:border-[#d4a574] transition-colors">
            </div>
            ...
            <div>
                ...
                <input type="text" name="twitter_url" value="{{ old('twitter_url') }}" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:outline-none focus:border-[#d4a574] transition-colors">
            </div>
        </div>
        ...
        <div class="border-t border-white/5 pt-6 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-gray-500 mt-2 ml-1">If blank, initials will be generated from name.</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <select name="gradient" required class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 appearance-none text-white focus:outline-none focus:border-[#d4a574] transition-colors cursor-pointer" style="background-color: #1a0f11;">
                            <option value="from-[#3B0000] to-[#4a1520]">Red to Dark Red (Founder Style)</option>
                            <option value="from-[#4a1520] to-[#d4a574]">Dark Red to Gold (CTO Style)</option>
                            <option value="from-[#d4a574] to-[#e8b44a]">Gold to Light Gold (Designer Style)</option>
                            <option value="from-[#e8b44a] to-[#c49a6b]">Light Gold to Sand (Marketing Style)</option>
                            <option value="from-[#c49a6b] to-[#8b6f47]">Sand to Bronze (Dev Style)</option>
                            <option value="from-[#8b6f47] to-[#3B0000]">Bronze to Red (PM Style)</option>
                        </select>
