...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.email_templates.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        <div class="glass-card p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    ...
                    <input type="text" name="template_name" value="{{ old('template_name') }}" required placeholder="e.g., Summer Promotion 2024"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="subject" value="{{ old('subject') }}" required placeholder="e.g., Exclusive 20% Off for You!"
                        class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-[#d4a574] transition-all text-white font-medium">
                </div>
            </div>
        </div>
        ...
        <div class="glass-card p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div class="space-y-2">
                    ...
                    <input type="text" name="brand_name" value="{{ old('brand_name', 'HA Tech') }}" required
                        class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-[#d4a574] transition-all text-white font-medium">
                </div>
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-2">Brand Tagline</label>
                    <input type="text" name="tagline" value="{{ old('tagline', 'GEN Z EVOLUTION') }}" required
                        class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-[#d4a574] transition-all text-white font-medium">
                </div>
            </div>

            <div class="space-y-2">
                <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-2">Custom Logo (Leave empty for default HA Tech logo)</label>
        ...
        <div class="glass-card p-10">
            ...
            <div class="space-y-2">
                ...
                <textarea name="content" rows="10" required
                    ...
                    placeholder="Write your email body here..."></textarea>
            </div>
        </div>
        ...
        <div class="glass-card p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="contact_phone" value="{{ old('contact_phone', '+92 325 9220167') }}" required
                ...
                <div class="space-y-2">
                    ...
                    <input type="email" name="contact_email" value="{{ old('contact_email', 'contact@hatechservices.com.pk') }}" required
                        class="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 outline-none focus:border-[#d4a574] transition-all text-white text-sm">
                </div>
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-2">Website</label>
                    <input type="text" name="website_url" value="{{ old('website_url', 'www.hatechservices.com.pk') }}" required
                        class="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 outline-none focus:border-[#d4a574] transition-all text-white text-sm">
                </div>
            </div>
        </div>
